...
public class VentanaPrincipal extends JFrame {
	...
	private JLabel getLbLogo() {
		...
		lbLogo.setBounds(10, 42, 153, 130);
		return lbLogo;
	...
	private JLabel getLbMcDonalds() {
		...
		lbMcDonalds.setBounds(169, 121, 281, 31);
		return lbMcDonalds;
	}
	...
	private JLabel getLbArticulos() {
		if (lbArticulos == null) {
			...
			lbArticulos.setBounds(10, 188, 57, 14);
		}
		return lbArticulos;
	}
	...
	private JComboBox<Articulo> getCbArticulos() {
		if (cbArticulos == null) {
			...
			cbArticulos.setBounds(10, 212, 319, 22);
		}
		return cbArticulos;
	}
	...
	private JScrollPane getScrollPanePedido() {
		if (scrollPanePedido == null) {
			...
			scrollPanePedido.setBounds(434, 60, 183, 69);
